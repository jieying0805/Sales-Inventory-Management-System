...
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="glyphicon glyphicon-check"></i>	Customer Sales Report
			</div>
			<!-- /panel-heading -->
	...
	<!-- /col-dm-12 -->
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Customer Sales Report</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">

				<div class="remove-messages"></div>			
				<div id="printTableWrapper">
				<table id="manageCustomerSalesTable" class="table table-striped">
					<thead>
						<tr>
							<th>Customer ID</th>
							<th>Name</th>
							<th>Number of Order</th>
							<th>Total Number of Item Purchased</th>
							<th>Total Sales</th>
						</tr>
					</thead>
					<tbody>
...
<script src="custom/js/customerSales.js"></script>
