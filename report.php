	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="glyphicon glyphicon-check"></i>	My Sales Report
			</div>
			<!-- /panel-heading -->
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Report Report</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				<div class="remove-messages"></div>	
				<div id="printTableWrapper">				
				<table id="manageReportTable" class="table table-striped">
					<thead>
						<tr>
							<th>Order ID</th>
							<th>Order Date</th>
