...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Profit Report</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				<div class="remove-messages"></div>	
				<div id="printTableWrapper">				
				<table id="manageProfitTable" class="table table-striped">
					<thead>
						<tr>
							<th>Order ID</th>
							<th>Order Date</th>
...
<script src="custom/js/profit.js"></script>
